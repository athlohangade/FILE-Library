...
void testsuiteread() {
	...
	printf("TEST 1 :\n");
	fd = myfopen("./d0", "w");	//to create a file for reading
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	fd = myfopen("./d0", "r");	//if no. of bytes to be read are greater than filelength
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	fd = myfopen("./d0", "r");		//if size of data to be read in is less than actual no. of bytes to be read
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 2 :\n");
	fd = myfopen("./d1", "w");	//to create a file for reading
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	fd = myfopen("./d1", "r");		//read attempt in same in buffer
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 5 :\n");
	fd = myfopen("./d2", "w");	//to create a file for reading
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	fd = myfopen("./d2", "r");		//read attempt in next or previous sequential buffer
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 6 :\n");
	ch = 'A';
	fd = myfopen("./d3", "w");	//to create file for reading
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	fd = myfopen("./d3", "r");			//read attempt in next or previous non-sequential buffer
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 7 :\n");
	fd = myfopen("./d23", "w");	//to create binary file for reading
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	fd = myfopen("./d23", "r");	//if no. of bytes to be read are greater than filelength
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 8 :\n");
	fd = myfopen("./d24", "w");		//create file for writing
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	fd = myfopen("./d24", "r");		//to test the eof and myfeof function
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
...
void testsuitewrite() {
	...
	printf("TEST 1 :\n");
	fd = myfopen("./d4", "w");		//attempt to write more bytes than size of data provided
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 2 :\n");
	fd = myfopen("./d5", "w");		//simple write attempt to write some no. of bytes
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 3 :\n");
	fd = myfopen("./d6", "w");		//write attempts in the same buffer
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 4 :\n");
	fd = myfopen("./d7", "w");		//write attempt in same buffer
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 5 :\n");
	fd = myfopen("./d8", "w");			//attempt to write in next and previous sequential buffer
	if(fd == NULL) {
		printf("open failed....\n");
		return;
	}
	...
	printf("TEST 6 :\n");
	ch = 'A';
	fd = myfopen("./d9", "w");			//attempt to write in next and previous non-sequential buffer
	if(fd == NULL) {
		printf("open failed....\n");
		return;
	}
	...
	printf("TEST 7 :\n");
	fd = myfopen("./d22", "w");	//if no. of bytes to be read are greater than filelength
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
...
void testsuiteappend() {
	...
	printf("TEST 1 :\n");
	fd = myfopen("./d10", "a");		//attempt to append in the same buffer
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 2 :\n");
	fd = myfopen("./d11", "a");		//attempt to append in the next sequential buffer
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 3 :\n");
	ch = 'A';
	fd = myfopen("./d12", "a");		//attempt to append upto a non-sequential buffer i.e. bufno '1' to bufno '3'
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
...
void testsuitereadplus() {
	...
	printf("TEST 1 :\n");
	fd = myfopen("./d13", "w");			//to create a file for reading/writing
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	fd = myfopen("./d13", "r+");			//read/write attempts in the same buffer
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 2 :\n");
	fd = myfopen("./d14", "w");			//to create a file for reading/writing
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	fd = myfopen("./d14", "r+");		//read/write attempts in the next and previous sequential buffer
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 3 :\n");
	ch = 'A';
	fd = myfopen("./d15", "w");		//to create a file for reading/writing
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	fd = myfopen("./d15", "r+");		//read/write attempts in the next and previous non-sequential buffer
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
...
void testsuitewriteplus() {
	...
	off_t a; 
	printf("TEST 1 :\n");
	fd = myfopen("./d16", "w+");			//read/write attempts in the same buffer
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 2 :\n");
	fd = myfopen("./d17", "w+");		//read/write attempts in the next and previous sequential buffer
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 3 :\n");
	ch = 'A';
	fd = myfopen("./d18", "w+");		//read/write attempts in the next and previous non-sequential buffer
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
...
void testsuiteappendplus() {
	...
	off_t a;
	printf("TEST 1 :\n");
	fd = myfopen("./d19", "a+");			//read/append attempts in the same buffer
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 2 :\n");
	fd = myfopen("./d20", "w");	//to create file for appending/reading
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	fd = myfopen("./d20", "a+");		//read/append attempts in the next and previous sequential buffer
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
	...
	printf("TEST 3 :\n");
	ch = 'A';
	fd = myfopen("./d21", "a+");		//read/append attempts in the next and previous non-sequential buffer
	if(fd == NULL) {
		printf("Open failed\n");
		return;
	}
